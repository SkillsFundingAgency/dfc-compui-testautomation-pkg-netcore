...
namespace DFC.TestAutomation.UI.Helper
{
        ...
        where T : IAppSettings
    {
        ...
        public HelperLibrary(IWebDriver webDriver, ISettingsLibrary<T> settingsLibrary)
        {
            ...
            this.BrowserStackHelper = new BrowserStackHelper<T>(settingsLibrary.BrowserStackSettings, settingsLibrary.BuildSettings, settingsLibrary.TestExecutionSettings.TimeoutSettings);
        }
